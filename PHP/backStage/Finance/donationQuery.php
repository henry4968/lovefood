<?php 
    ...
    if(is_Date($dateStart) && is_Date($dateEnd)){
        ...
        $sqlDonationLog = "SELECT DONATION_ID, DONATION_NAME, DONATION_EMAIL, DONATION_PERSONAL_ID_OR_TAX_ID, DONATION_PLAN, DONATION_AMOUNT, DONATION_DATE FROM DONATION WHERE DONATION_ID like ? and DONATION_NAME like ? and DONATION_EMAIL like ? and DONATION_PERSONAL_ID_OR_TAX_ID like ? and DONATION_DATE >= ? and DONATION_DATE <= ?";
