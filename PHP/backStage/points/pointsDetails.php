...
$sqlDiscountLog = "SELECT ORDER_ID, ORDER_DISCOUNT, ORDER_DATE FROM Lovefood.ORDER WHERE MEMBER_ID_for_OD like ? and ORDER_PICKUP_DATE between ? and ? and ORDER_DISCOUNT is not null";
