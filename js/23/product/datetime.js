...
// ReSharper disable once InconsistentNaming
    DateTimePicker = function (element, options) {
		...
		icons = {
		    ...
		    up: 'glyphicon glyph icon-chevron-up',
		    down: 'glyphicon glyph icon-chevron-down'
		},
            ...
            return (
                '<div class="timepicker-picker">' +
                    '<table class="table-condensed">' +
						'<tr>' +
							'<td><button type="button" class="btn btn-time" data-action="incrementHours"><i class="glyphicon glyphicon-chevron-up"></i></button></td>' +
							'<td class="separator"></td>' +
							'<td>' + (picker.options.useMinutes ? '<button type="button" class="btn btn-time" data-action="incrementMinutes"><i class="glyphicon glyphicon-chevron-up"></i></button>' : '') + '</td>' +
                            (picker.options.useSeconds ?
                                '<td class="separator"></td><td><button type="button" class="btn btn-time" data-action="incrementSeconds"><i class="glyphicon glyphicon-chevron-up"></i></button></td>' : '') +
						...
						'<tr>' +
							...
							(picker.options.use24hours ? '' : '<td class="separator"></td>' +
							'<td><button type="button" class="btn btn-brown" data-action="togglePeriod"></button></td>') +
						'</tr>' +
						'<tr>' +
							'<td><button type="button" class="btn btn-time" data-action="decrementHours"><i class="glyphicon glyphicon-chevron-down"></i></a></td>' +
							'<td class="separator"></td>' +
							'<td>' + (picker.options.useMinutes ? '<button type="button" class="btn btn-time" data-action="decrementMinutes"><i class="glyphicon glyphicon-chevron-down"></i></button>' : '') + '</td>' +
                            (picker.options.useSeconds ?
                                '<td class="separator"></td><td><button type="button" class="btn btn-time" data-action="decrementSeconds"><i class="glyphicon glyphicon-chevron-down"></i></button></td>' : '') +
							(picker.options.use24hours ? '' : '<td class="separator"></td>') +
						'</tr>' +
                    '</table>' +
                '</div>' +
